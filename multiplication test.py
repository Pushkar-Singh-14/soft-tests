...
path="/Users/pushkarsingh/Desktop/revise_mul.txt"
path_report="/Users/pushkarsingh/Desktop/Tests/Reports/multiplication test.txt"
...
try:
    ...
    score={}%
    Avg Consume time={}
    Total time={} min""".format(total_count,correct,wrong,round(score,2),avg,round(timer/60,2)))
    f_report=open(path_report,"a+")
    date_stamp=time.strftime('%Y-%m-%d')
    f_report.write(("{} {} {} {} {} {}\n".format(date_stamp,score,timer/60,avg,a,b)))
    f_report.close()
